		...
		<div class="container" style="width: auto; padding: 20px 0px 0px 0px;">
			<div class="span3 bs-docs-sidebar">
				<ul class="nav nav-list bs-docs-sidenav">
                    ...
                    <li  class="active"><a href="#"><i class="icon-chevron-right"></i>New Notifications</a></li>
			...
			$notifications = DB::query("SELECT * FROM notifications WHERE username=%s and viewed=0 ORDER by time DESC", $_SESSION['username']);
			$counter = 0;
