		...
		<div class="container" style="width: auto; padding: 20px 0px 0px 0px;">
			...
			<div class="bs-docs-sidebar">
				<ul class="nav nav-list bs-docs-sidenav">
					...
					<li  class="active"><a href=""><i class="icon-chevron-right"></i>Archived Transactions</a></li>
			...
			foreach($offers as $offer){
				...
				if($item['owner']!=$_SESSION['username']){	
					if($counter!=0 && $counter%3==0){
						...
						echo '<p>Status: You reported transaction as complete while the seller reported it as incomplete. You can report user if you believe he/she has made a false claim.</p>'; 

						if($transaction['status']=='bisc')
						echo '<p>Status: You reported transaction as incomplete while the seller reported it as complete.</p>'; 


						if($transaction['status']=='totalcompleted')
						echo '<p>Status: Successful Transaction</p>';

						if($transaction['status']=='totalincomplete')
						echo '<p>Status: Both users reported incomplete transaction</p>';
			...
			foreach($offers as $offer){
				...
				if($item['owner']==$_SESSION['username']){	
					if($counter!=0 && $counter%3==0){
						...
						if($transaction['status']=='bisc')
						echo '<p>Status: You reported transaction as complete while the buyer reported it as incomplete. You can report user if you believe he/she has made a false claim.</p>'; 

						if($transaction['status']=='totalcompleted')
						echo '<p>Status: Successful Transaction</p>';

						if($transaction['status']=='bcsi')
						echo '<p>Status: You reported transaction as incomplete while the buyer reported it as complete.</p>'; 
