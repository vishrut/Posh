        ...
        <div class="container" style="width: auto; padding: 20px 0px 0px 0px;">
			<div class="span3 bs-docs-sidebar">
				<ul class="nav nav-list bs-docs-sidenav">
					...
					<li ><a href="helpcenter.php"><i class="icon-chevron-right"></i>FAQ's</a></li>
			...
			<?php
				...
				DB::query("INSERT INTO `reportabuse`(`reporter`, `abuser`, `details`) VALUES ($reporter,$abuser,$details)");
