		...
		<?php
			...
			foreach ($comments as $comment) {
				...
				if($comment['commenter']==$_SESSION['username'])
					echo '<br><a href="deletecomment.php?prev=viewcommentsswap.php?offerid='.$thisofferid.'&commentid='.$comment['commentid'].'">Delete</a>';
			...
			<form name="comment" class="form-horizontal" action="submitcomment.php" method="post">
				...
				<input type="hidden" name="prev" value="viewcommentsswap.php?offerid=<?php echo $_GET['offerid'];?>"></input>
