		...
		<div class="container" style="width: auto; padding: 20px 0px 0px 0px;">
			...
			foreach ($comments as $comment) {
				...
				if($comment['commenter']==$_SESSION['username'])
					echo '<br><a href="deletecomment.php?prev=viewofferbuy.php?offerid='.$thisofferid.'&commentid='.$comment['commentid'].'">Delete</a>';
			...
			<form name="comment" class="form-horizontal" action="submitcomment.php" method="post">
				...
				<input type="hidden" name="prev" value="viewofferbuy.php?offerid=<?php echo $_GET['offerid'];?>"></input>
