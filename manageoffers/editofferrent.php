  ...
  <head>
	...
	<body>
		...
		<div class="container" style="width: auto; padding: 20px 0px 0px 0px;">
			...
			<?php
			if($offerdetails['ssr']=='rent'){
			$rentdetails = 	DB::query("SELECT * FROM rentdetails WHERE offerid=%i", $_GET['offerid']);
			$rentdetails = $rentdetails[0];
			echo '<div class="row-fluid">
			<p>	
			<form name="editrentoffer" class="form-horizontal" action="updaterentoffer.php" method="post" enctype="multipart/form-data">
						<input type="hidden" name="offerid" id="offeridgroup" value="'.$rentdetails['offerid'].'" />
						...
						<div class="control-group" id="startgroup">
							...
							<div class="controls">
							<input class="span4" required name="startdate" id="dpd1" type="text" value="'.$rentdetails['startdate'].'">
						...
						<div class="control-group" id="endgroup">
							...
							<div class="controls">
							<input class="span4" required name="enddate" id="dpd2" type="text" value="'.$rentdetails['enddate'].'">
						...
						<div class="control-group" id="amountgroup">
							...
							<div class="input-prepend">
								...
								<input class="span4" id="inputAmount" required name="amount" type="text" placeholder="" value="'.$rentdetails['amount'].'">
							</div>
						...
						<div class="control-group">
							<div class="controls">
							<button type="submit" class="btn btn-large btn-success">Edit Offer</button>
							</div>
						</div>
			</form>		
			</p>		
