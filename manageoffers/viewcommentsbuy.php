		...
		<div class="container" style="width: auto; padding: 20px 0px 0px 0px;">
			<div class="span3 bs-docs-sidebar">
				<ul class="nav nav-list bs-docs-sidenav">
					<li  class="active"><a href="listoffersbyme.php"><i class="icon-chevron-right"></i>Offers I Made</a></li>
			...
			<table class="table table-hover">
				...
				<tr>
					...
					<td><?php echo $offerdetails['cash']?></td>
				</tr>
			</table>
			</div>
			...
			foreach ($comments as $comment) {
				...
				if($comment['commenter']==$_SESSION['username'])
					echo '<br><a href="deletecomment.php?prev=viewcommentsbuy.php?offerid='.$thisofferid.'&commentid='.$comment['commentid'].'">Delete</a>';
			...
			<form name="comment" class="form-horizontal" action="submitcomment.php" method="post">
				...
				<input type="hidden" name="prev" value="viewcommentsbuy.php?offerid=<?php echo $_GET['offerid'];?>"></input>
